...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spotipy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12076&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spotipy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spotipy` can be installed with:

```
conda install spotipy
```

It is possible to list all of the versions of `spotipy` available on your platform with:
